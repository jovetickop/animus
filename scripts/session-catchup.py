...
def print_recovery_report(session_dir, sessions_info, features_writes_per_session):
    ...
    state_dir = os.path.join(os.path.dirname(session_dir), "..", "harness-cc")
    # 统一路径：features.json 固定在 .claude/harness-cc/
    features_candidates = [
        os.path.join(os.path.dirname(session_dir), "..", "harness-cc", "features.json"),
    ]
